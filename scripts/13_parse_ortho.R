...
colnames(ogroups_presence_absence)<-c("Orthogroup","TAIR10","Rab R1","Anz 0","sum")
genomes[2]<- "Rab R1"
genomes[3]<- "Anz 0"

ogroups_presence_absence
...
upset(ogroups_presence_absence, genomes, name = "Common Orthogroups", width_ratio = 0.1, wrap = TRUE, set_sizes = FALSE)
dev.off()
