...
#SBATCH --output=/data/users/tschlatter/GenomeandTranscriptome/output_AEDFilter_%j.o
#SBATCH --error=/data/users/tschlatter/GenomeandTranscriptome/error_AEDFilter_%j.e
