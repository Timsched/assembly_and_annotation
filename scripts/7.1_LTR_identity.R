...
#SBATCH --output=/data/users/tschlatter/GenomeandTranscriptome/output_TEsorter_%j.o
#SBATCH --error=/data/users/tschlatter/GenomeandTranscriptome/error_TEsorter_%j.e
#!/usr/bin/Rscript
...
# Load the data
anno_data=read.table("/data/users/tschlatter/GenomeandTranscriptome/Annotation/EDTA_results2/assembly.fasta.mod.EDTA.raw/assembly.fasta.mod.LTR.intact.gff3",header=F,sep="\t")
head(anno_data)
# Get the classification table
classification=fread("/data/users/tschlatter/GenomeandTranscriptome/Annotation/EDTA_results2/assembly.fasta.mod.EDTA.raw/assembly.fasta.mod.LTR.intact.fa.rexdb-plant.dom.tsv")
